#create a Logistic Regression-like classifier on top of the extracted features and then train it using PyTorch functions.
...
for param in model.parameters():
	param.requires_grad = False #Since we’ll be using ResNet for feature extraction, and therefore no actual “learning” needs to take place in the body of the network, we freeze all layers in the body of the network
